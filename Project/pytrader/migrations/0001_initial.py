...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pytrader_traderprofile', (
            ...
            ('last_trade', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 4, 29, 18, 14, 0, 613482))),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 22, 14, 0, 686267, tzinfo=<UTC>)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 22, 14, 0, 686142, tzinfo=<UTC>)'}),
        ...
        'pytrader.traderprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_trade': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 29, 18, 14, 0, 613482)'}),
